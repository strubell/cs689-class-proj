...
java -classpath $FAC_CP -Xmx$MEMORY -ea -Djava.awt.headless=true -Dfile.encoding=UTF-8 -server cc.factorie.app.nlp.NLP --ontonotes-forward-pos=$MODEL_DIR/$POS_MODEL --transition-based-parser=$MODEL_DIR/$PARSE_MODEL
